// refer to README for instructions on how to run this JavaFX application
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        // Set up the window/stage title
        primaryStage.setTitle("Drawing App LV3");

        //Creating the canvas
        Canvas canvas = new Canvas(800, 600);

        // Creating the buttons that will be used for drawing
        RadioButton rbRect = new RadioButton("Rectangle (R)");
        RadioButton rbCircle = new RadioButton("Circle (T)");
        Button clearBtn = new Button("Clear (Y)");
        ...
        // ListView to show the shapes list
        ...
        // Update selectedInfo when selection changes (tooltip-like behavior) with an if-else statement
        ...
        // Keyboard shortcuts: C = clear, R = rectangle, O = circle, using switch case
        ...
        scene.setOnKeyPressed(ev -> {
            switch (ev.getCode()) {
                case Y:
                    ...
                    break;
                case R:
                    controller.setCurrentShape(DrawingController.ShapeType.RECTANGLE);
